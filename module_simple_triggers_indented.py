...
simple_triggers = [
    ...
    (
        ...
        [
            ...
            (
                ...
                "trp_notification_menu_var1",
                0,
            ),
            (
                troop_get_slot,
                "$g_notification_menu_var2",
                "trp_notification_menu_var2",
                0,
            ),
        ...
        [
            ...
            (try_begin),
	            ...
	            (
	                ...
	                ":caravan_distance_to_destination",
    ...
    (
        ...
        [
            (try_for_range, ":kingdom_no", npc_kingdoms_begin, npc_kingdoms_end),
	            ...
	            (
	                store_div,
	                ":faction_morale_div_10",
	                ":faction_morale",
	                ":divisor",
	            ),  # 10 is the base, down to 2 for 100 rtr
    ...
    (
        ...
        [
            ...
            (try_for_parties, ":party_no"),
	            ...
	            (
	                display_message,
	                "@{!}{s3} commander of party #{reg4} which is not his troop_leaded party {reg5}",
	            ),
            (try_end),
        ],
    ),
            ...
            (try_begin),
	            ...
	            (try_begin),
		            ...
		            (
		                ...
		                "mnu_notification_lady_requests_visit",
		                ":lady_not_visited_longest_time",
		                ":visit_lady_location",
		            ),
	            (try_end),
            (try_end),
    ...
    (
        ...
        [
            (
                ...
                1,
            ),  # cancel caravan_escort_state if caravan leaves the destination
            (try_begin),
        ...
        [
            ...
            (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
	            ...
	            (
	                ...
	                slot_town_lord,
	                "trp_player",
	            ),  # center does not belong to player.
	            (
	                party_slot_ge,
	                ":center_no",
	                slot_town_lord,
            ...
            (try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
	            ...
	            (try_for_range, ":unused", 0, ":num_hiring_rounds"),
		            (
		                ...
		                ":troop_no",
		            ),  # Hiring men with current wealth
	            (try_end),
            (try_end),
            (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
	            (
        ...
        [
            ...
            (try_begin),
	            ...
	            (
	                ...
	                ":target_faction",
	                ":target_village",
	            ),  # target faction receives the provocation
	            ...
	            (try_begin),
		            ...
		            (
		                call_script,
		                "script_add_notification_menu",
		                "mnu_notification_border_incident",
		                ":acting_village",
		                -1,
		            ),
	            (else_try),
		            ...
		            (try_begin),
			            ...
			            (try_begin),
				            ...
				            (
				                call_script,
				                "script_add_notification_menu",
				                "mnu_notification_truce_expired",
				                ":faction_1",
				                ":faction_2",
				            ),
			            (try_end),
		            ...
		            (try_begin),
			            ...
			            (else_try),  # Provocation expires
				            ...
				            (
				                call_script,
				                "script_add_notification_menu",
				                "mnu_notification_casus_belli_expired",
				                ":faction_1",
				                ":faction_2",
				            ),
				            (faction_set_slot, ":faction_1", ":slot_provocation_days", 0),
        ...
        [
            (try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
	            ...
	            (
	                ...
	                ":trainer_level",
	                5,
	            ),  # average trainer level is 3 for npc lords, worst : 0, best : 6
	            (
	                store_mul,
	                ":xp_gain",
	                ":trainer_level",
            ...
            (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
	            ...
	            (
	                ...
	                ":xp_gain",
	                3000,
	            ),  # xp gain in two days of period for each center, average : 3000.
	            (assign, ":max_accepted_random_value", 30),
	            (try_begin),
        ...
        [
            (try_for_range, ":kingdom_hero", active_npcs_begin, active_npcs_end),
	            (
	                ...
	                ":impatience",
	                ":kingdom_hero",
	                slot_troop_intrigue_impatience,
	            ),
        ...
        [
            ...
            (try_begin),
	            ...
	            (
	                ...
	                ":num_centers",
	                0,
	            ),  # if there is no walled centers that faction has defection happens 100%.
	            (
	                call_script,
	            ...
	            (try_begin),
		            ...
		            (try_begin),
			            ...
			            (
			                ...
			                ":attacker_strength",
			                2,
			            ),  # double the power of attackers if the player is in the campaign
		            (try_end),
		            (
		                party_get_slot,
		                ":siege_hardness",
		            ...
		            (try_begin),
			            (
			                ...
			                ":random_up_limit",
			                -100,
			            ),  # never attack if the strength ratio is less than 150%
			            (
			                store_div,
			                ":siege_begin_hours_effect",
			                ":siege_begin_hours",
			                2,
			            ),  # was 3 (1.126)
            ...
            (try_for_range, ":village_no", centers_begin, centers_end),
	            ...
	            (try_begin),  # Disaster
		            (
		                ...
		                ":random_no",
		                0,
		            ),  # 1% chance of epidemic - should happen once every two years
	            ...
	            (else_try),  # good grazing
		            ...
		            (
		                try_begin
		            ),  # if very low number of cattles and there is good grazing then increase number of cattles also by one
			            (le, ":num_cattle", 20),
			            (val_add, ":num_cattle", 1),
		            (try_end),
		            ...
		            (
		                try_begin
		            ),  # if very low number of sheeps and there is good grazing then increase number of sheeps also by one
			            (le, ":num_sheep", 20),
			            (val_add, ":num_sheep", 1),
		            (try_end),
	            (try_end),
            ...
            (try_for_range, ":center_no", centers_begin, centers_end),
	            (try_begin),
		            (
		                ...
		                slot_town_lord,
		                0,
		            ),  # unassigned centers do not accumulate rents
		            (
		                party_get_slot,
		                ":accumulated_rents",
		                ":center_no",
		            ...
		            ),  # prosperty changes between 0..100
		            (
		                store_add,
		                ":multiplier",
		                20,
		                ":prosperity",
		            ),  # multiplier changes between 20..120
		            ...
		            (
		                ...
		                ":accumulated_rents",
		                ":cur_rents",
		            ),  # cur rents changes between 23..1000
		            (
		                party_set_slot,
		                ":center_no",
		                slot_center_accumulated_rents,
	            ...
	            (try_begin),
		            ...
		            (
		                ...
		                ":bound_castle",
		                slot_center_accumulated_rents,
		            ),  # castle's accumulated rents
		            (
		                val_add,
		                ":accumulated_rents",
		                ":cur_rents",
		            ),  # add village's rent to castle rents
		            (
		                party_set_slot,
		                ":bound_castle",
		                slot_center_accumulated_rents,
            ...
            (try_for_range, ":troop_no", heroes_begin, heroes_end),
	            ...
	            (try_begin),
		            ...
		            (
		                ...
		                ":destination",
		                ":troop_party_no",
		            ),  # Moving prisoners to the center
		            (assign, "$g_move_heroes", 1),
        ...
        [
            (try_for_parties, ":party_no"),
	            ...
	            (else_try),
		            ...
		            (
		                try_begin
		            ),  # Make sure escorted caravan continues to its original destination.
            ...
            (try_for_parties, ":party_no"),
	            ...
	            (try_begin),
		            ...
		            (
		                ...
		                ":home_center",
		                3,
		            ),  # this needs to be the same as the center
            ...
            (try_for_range, ":cur_center", centers_begin, centers_end),
	            ...
	            (try_begin),
		            (
		                neg | party_slot_ge,
		                ":cur_center",
		                slot_center_last_player_alarm_hour,
		                ":hour_limit",
		            ),
            ...
            (try_begin),
	            ...
	            (try_begin),
		            ...
		            (
		                store_sub,
		                ":supply_cost",
		                ":initial_supply_budget",
		                "$player_supply_budget",
		            ),
		            ...
		            (
		                ...
		                ":supply_cost",
		                reg0,
		            ),  # Randomized rounding, to prevent gamey tricks
		            ...
		            (else_try),
			            (
			                display_message,
			                "@You can not afford to buy any more supplies from {s1}!",
			                0xFF8800,
			            ),
	            ...
	            (else_try),
		            (
		                display_message,
		                "@You did not receive the expected supplies from {s1}!",
		                0xFF8800,
		            ),
	            (try_end),
            (try_end),
    ...
    (
        ...
        [
            ...
            (try_begin),
	            ...
	            (
	                display_log_message,
	                "@{reg1} {s1} {reg2?have:has} escaped from your party during the night.",
	            ),
            (try_end),
    ...
    (
        ...
        [
            ...
            (
                ...
                ":difficulty_setting",
            ),  # On harder difficulties, spawn a few more bandits...
        ...
        [
            ...
            (try_for_parties, ":cur_party"),
	            ...
	            (
	                ...
	                ":kingdom_num_parties",
	                ":party_faction",
	                slot_faction_number_of_parties,
	            ),
	            ...
	            (else_try),
		            ...
		            (try_begin),
			            ...
			            (
			                ...
			                0,
			            ),  # remove pretender from the world
		            (try_end),
		            (assign, ":faction_removed", 1),
		            (try_begin),
			            ...
			            (
			                call_script,
			                "script_add_notification_menu",
			                "mnu_notification_oath_renounced_faction_defeated",
			                ":cur_kingdom",
			                0,
			            ),
		            (try_end),
		            ...
		            (
		                call_script,
		                "script_add_notification_menu",
		                "mnu_notification_faction_defeated",
		                ":cur_kingdom",
		                0,
		            ),
	            (try_end),
            ...
            (try_begin),
	            ...
	            (try_for_range, ":cur_kingdom", kingdoms_begin, kingdoms_end),
		            ...
		            (
		                call_script,
		                "script_add_notification_menu",
		                "mnu_notification_one_faction_left",
		                ":cur_kingdom",
		                0,
		            ),
	            (try_end),
        ...
        [
            ...
            (try_for_parties, ":bandit_party"),
	            ...
	            (
	                ...
	                ":bandit_lair",
	                ":bandit_party_template",
	                slot_party_template_lair_party,
	            ),
	            (
	                try_begin
	            ),  # If party is active and bandit is far away, then move to location
	            ...
	            (else_try),  # Otherwise, act freely
		            ...
		            (try_begin),
			            ...
			            (
			                ...
			                ":spawnpoint_end",
			                ":bandit_party_template",
			                slot_party_template_lair_spawnpoint_end,
			            ),
			            (
			                store_random_in_range,
			                ":spawnpoint",
    ...
    (
        ...
        [
            ...
            (
                ...
                "$g_player_reading_book",
                slot_item_book_reading_progress,
            ),
            (
                item_get_slot,
                ":book_read",
		            ...
		            (try_begin),
			            ...
			            (else_try),
				            ...
				            (
				                ...
				                ":cur_quest",
				                7,
				                "@You have {reg0} days to finish this quest.",
				                0,
				            ),
			            (try_end),
		            (try_end),
        ...
        [
            (try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
	            ...
	            (
	                neg | party_slot_ge,
	                ":party_no",
	                slot_party_follow_player_until_time,
	                ":cur_time",
	            ),
	            ...
	            (
	                party_set_slot,
	                ":party_no",
	                slot_party_dont_follow_player_until_time,
	                ":dont_follow_time",
	            ),
            (try_end),
        ],
        ...
        [
            ...
            (else_try),
	            ...
	            (
	                ...
	                ":max_collected_tax",
	                80,
	            ),  # Prosperity of 50 gives the default values
	            (try_begin),
            ...
            (else_try),
	            ...
	            (try_begin),
		            ...
		            (
		                ...
		                slot_troop_woman_to_woman_string,
		            ),  # was npc_with_sisterly advice
        ...
        [
            (try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
	            ...
	            (try_begin),
		            ...
		            (
		                display_message,
		                "@{!}DEBUG - {s4} faction changed from slot_troop_change_to_faction",
		            ),
	            (try_end),
	            (
	                call_script,
	            ...
	            (try_begin),
		            ...
		            (try_begin),
			            ...
			            (
			                call_script,
			                "script_add_notification_menu",
			                "mnu_notification_troop_left_players_faction",
			                ":troop_no",
			                ":new_faction_no",
			            ),
		            (else_try),
			            ...
			            (
			                call_script,
			                "script_add_notification_menu",
			                "mnu_notification_troop_joined_players_faction",
			                ":troop_no",
			                ":faction_no",
			            ),
		            (try_end),
    ...
    (
        ...
        [
            ...
            (
                party_get_slot,
                ":is_there_already_fire",
                ":village_no",
                slot_village_smoke_added,
            ),
            ...
            (try_begin),
	            ...
	            (try_begin),
		            ...
		            (
		                display_message,
		                "@{!}DEBUG - Checking fire at {s4} for {s5} - current time {reg3}, last nearby fire {reg4}",
		            ),
	            (try_end),

...
animations = [
    [
        ...
        [
            ...
            50,
            52,
            arf_use_stand_progress | arf_cyclic,
            0,
            (0, 0, 0),
            0.25,
        ],
        ...
        [
            ...
            80,
            82,
            arf_use_stand_progress | arf_cyclic | arf_two_handed_blade,
            0,
            (0, 0, 0),
            0.5,
        ],
    ...
    [
        "jump",
        acf_enforce_lowerbody,
        amf_priority_jump | amf_play | amf_client_prediction | amf_continue_to_next,
    ...
    [
        "jump_loop",
        acf_enforce_lowerbody,
        amf_priority_jump | amf_play | amf_client_prediction,
    ...
    [
        "jump_end",
        acf_enforce_lowerbody,
        amf_priority_jump_end | amf_play | amf_client_prediction,
    ...
    [
        "turn_right",
        acf_enforce_lowerbody,
        amf_play | amf_client_prediction,
        [
            0.95,
            "stand_man",
            0,
    ...
    [
        ...
        [
            ...
            0,
            23,
            arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
            (0, 0, 0),
            0.0,
        ],
    ...
    [
        "kick_right_leg",
        acf_enforce_lowerbody,
        amf_priority_kick | amf_play | amf_client_prediction,
        ##   [1.09, "jump", 22, 48, arf_blend_in_1],
    ...
    [
        "run_forward",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        ...
        [
            ...
            0,
            24,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
            (0, 0, 0),
            0.4,
        ],
    ...
    [
        ...
        [
            0.8,
            "run_man_forward_onehanded",
            0,
            24,
            arf_use_walk_progress | arf_cyclic | arf_make_walk_sound,
            pack2f(0.4, 0.9),
            (0, 0, 0),
            0.4,
        ],
    ...
    [
        ...
        [
            0.8,
            "run_man_forward_right_onehanded",
            0,
            24,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        ...
        [
            0.8,
            "run_man_forward_right_greatsword",
            0,
            24,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        ...
        [
            0.8,
            "run_man_forward_left_onehanded",
            0,
            24,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        ...
        [
            0.8,
            "run_man_forward_left_greatsword",
            0,
            24,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "run_backward_right_staff",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        #   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
        [
            0.7,
            "run_backward_staff_right",
            0,
            21,
            arf_use_inv_walk_progress
            | arf_cyclic
    ...
    [
        "run_backward_right_greatsword",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        #   [1.0, "anim_human", 7240, 7200, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
        [
            0.7,
            "run_backward_twohanded_right",
            0,
            21,
            arf_use_inv_walk_progress
            | arf_cyclic
    ...
    [
        "run_backward_left_staff",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        #   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
        [
            0.7,
            "run_backward_staff_left",
            0,
            21,
            arf_use_inv_walk_progress
            | arf_cyclic
    ...
    [
        "run_backward_left_greatsword",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        #   [1.0, "anim_human", 7240, 7200, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
        [
            0.7,
            "run_backward_twohanded_left",
            0,
            21,
            arf_use_inv_walk_progress
            | arf_cyclic
    ...
    [
        "walk_right_onehanded",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_right_onehanded_r",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_right_twohanded",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_right_greatsword_r",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_forward_right_onehanded",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_crossright_onehanded",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_forward_right_twohanded",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_crossright_greatsword",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_forward_right_polearm",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_crossright_staff",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_forward_left_onehanded",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_crossleft_onehanded",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_forward_left_twohanded",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_crossleft_greatsword",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_forward_left_polearm",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
            "walk_crossleft_staff",
            0,
            32,
            arf_use_walk_progress | arf_cyclic | blend_in_walk | arf_make_walk_sound,
            pack2f(0.4, 0.9),
    ...
    [
        "walk_backward_right_hips_right",
        acf_enforce_lowerbody,
        amf_use_cycle_period | amf_client_prediction,
        [
            1.0,
    ...
    [
        "ride_rear",
        acf_enforce_lowerbody | acf_ignore_slope,
        amf_priority_mount | amf_play | amf_client_prediction,
    ...
    [
        "dismount_horse",
        acf_enforce_lowerbody | acf_displace_position,
    ...
    [
        "lancer_ride_0",
        acf_enforce_lowerbody,
        amf_priority_ride | amf_play | amf_client_prediction,
    ...
    [
        "equip_default",
        0,
        amf_priority_equip | amf_play | amf_restart | amf_client_prediction,
    ...
    [
        "unequip_bow_left_hip",
        0,
        amf_priority_equip | amf_play | amf_restart | amf_client_prediction,
        [0.3, "equip_arms", 115, 108, arf_blend_in_0],
    ],
    [
        "cancel_attack_onehanded",
        0,
        amf_priority_cancel
    ...
    [
        "ready_bow",
        acf_rot_vertical_bow | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_keep
        ...
        [
            ...
            combat + 500,
            combat + 530,
            blend_in_ready | arf_make_custom_sound,
            pack2f(0.14, 0.44),
        ],
    ],
    [
    ...
    [
        ...
        [
            ...
            combat + 1700,
            combat + 1750,
            arf_blend_in_8 | arf_make_custom_sound,
            pack2f(0.40, 0.94),
        ],
    ],
    [
        "reload_crossbow_horseback",
        0,
        amf_priority_reload | amf_use_weapon_speed | amf_play,
        [
            1.6,
    ...
    [
        "ready_pistol",
        acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_keep
        | amf_client_owner_prediction
    ...
    [
        "release_swingright_fist_continue",
        0,
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_swingleft_fist_continue",
        0,
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_direct_fist",
        0,
        amf_priority_attack | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [0.5, "direct_fist", 17, 36, blend_in_release],
    ],
    [
        "release_direct_fist_continue",
        0,
        amf_priority_attack | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [0.5, "direct_fist", 17, 36, blend_in_release],
    ],
    ...
    [
        "release_uppercut_fist",
        0,
        amf_priority_attack | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [0.5, "uppercut", 17, 34, blend_in_release],
    ],
    [
        "release_uppercut_fist_continue",
        0,
        amf_priority_attack | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [0.5, "uppercut", 17, 34, blend_in_release],
    ],
    [
        "blocked_uppercut_fist",
        0,
        amf_priority_blocked | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [
            attack_blocked_duration,
    ...
    [
        "ready_slashright_twohanded",
        acf_right_cut | acf_rot_vertical_bow | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_use_inertia
        | amf_keep
    ...
    [
        "release_slashright_twohanded_continue",
        0,
    ...
    [
        "release_slashleft_twohanded",
        acf_right_cut | acf_rot_vertical_bow | acf_anim_length(100),
        amf_priority_attack | amf_use_weapon_speed | amf_play | amf_continue_to_next,
        [0.61, "slashleft_twohanded", 16, 38, blend_in_release],
    ],
    [
        "release_slashleft_twohanded_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "ready_thrust_twohanded",
        acf_thrust | acf_rot_vertical_bow | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_use_inertia
        | amf_keep
    ...
    [
        "release_thrust_twohanded",
        acf_thrust | acf_rot_vertical_bow | acf_anim_length(100),
        amf_priority_attack | amf_use_weapon_speed | amf_play | amf_continue_to_next,
        # ORIGINAL: [0.61, "anim_human", combat + 6010, combat + 6031, blend_in_release],
        [0.46, "anim_human", combat + 6010, combat + 6031, blend_in_release],
    ],
    [
        "release_thrust_twohanded_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "blocked_thrust_twohanded",
        0,
        amf_priority_blocked | amf_use_weapon_speed | amf_play,
        [
            attack_blocked_duration_thrust,
            "anim_human",
            combat + 6015,
            combat + 6016,
            blend_in_parry,
    ...
    [
        "parried_thrust_twohanded",
        0,
        amf_priority_parried | amf_use_weapon_speed | amf_play,
        [
            attack_parried_duration_thrust,
            "anim_human",
            combat + 6015,
            combat + 6016,
            blend_in_parry,
    ...
    [
        "release_overswing_twohanded_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        ...
        # ORIGINAL: [0.62, "attacks_thrust_onehanded", 12, 32, blend_in_release],
        [0.47, "attacks_thrust_onehanded", 12, 32, blend_in_release],
    ],
    [
        "release_thrust_onehanded_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_thrust_onehanded_horseback_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "blocked_thrust_onehanded_horseback",
        acf_enforce_rightside,
        amf_priority_blocked | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [
            attack_blocked_duration_thrust,
    ...
    [
        "parried_thrust_onehanded_horseback",
        acf_enforce_rightside,
        amf_priority_parried | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [
            attack_parried_duration_thrust,
    ...
    [
        ...
        # ORIGINAL: [0.62, "thrust_onehanded_lance_hb", 8, 33, blend_in_release],
        [0.47, "thrust_onehanded_lance_hb", 8, 33, blend_in_release],
    ],
    [
        "release_thrust_onehanded_lance_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "blocked_thrust_onehanded_lance",
        acf_enforce_rightside,
        amf_priority_blocked | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [
            attack_blocked_duration_thrust,
    ...
    [
        "parried_thrust_onehanded_lance",
        acf_enforce_rightside,
        amf_priority_parried | amf_use_weapon_speed | amf_play | amf_rider_rot_thrust,
        [
            attack_parried_duration_thrust,
    ...
    [
        "ready_slashright_onehanded",
        acf_right_cut | acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_use_inertia
        | amf_keep
    ...
    [
        "release_slashright_onehanded_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    ## ],
    [
        "ready_slashleft_onehanded",
        acf_left_cut | acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_use_inertia
        | amf_keep
    ...
    [
        "release_slashleft_onehanded_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        ...
        acf_overswing | acf_enforce_rightside,
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_use_inertia
        | amf_keep
    ...
    [
        "release_overswing_onehanded_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_slash_horseback_right_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_slash_horseback_left_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "ready_slash_horseback_polearm_right",
        acf_right_cut | acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_use_inertia
    ...
    [
        "release_slash_horseback_polearm_right",
        acf_right_cut | acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_slash_horseback_polearm_right_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "blocked_slash_horseback_polearm_right",
        acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_blocked
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "parried_slash_horseback_polearm_right",
        acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_parried
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "ready_slash_horseback_polearm_left",
        acf_left_cut | acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_use_inertia
    ...
    [
        "release_slash_horseback_polearm_left",
        acf_left_cut | acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_slash_horseback_polearm_left_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "blocked_slash_horseback_polearm_left",
        acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_blocked
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "parried_slash_horseback_polearm_left",
        acf_rot_vertical_sword | acf_anim_length(100),
        amf_priority_parried
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_overswing_staff_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_thrust_staff",
        acf_thrust | acf_rot_vertical_bow | acf_anim_length(100),
        amf_priority_attack | amf_use_weapon_speed | amf_play,
        # ORIGINAL: [0.6, "attacks_staff_thrust", 21, 40, blend_in_release],
        [0.45, "attacks_staff_thrust", 21, 40, blend_in_release],
    ],
    [
        "release_thrust_staff_continue",
        acf_thrust | acf_rot_vertical_bow | acf_anim_length(100),
        amf_priority_attack
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_slashleft_staff_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_slashright_staff_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        ...
        | amf_client_owner_prediction,
        [
            defend_keep_duration,
            "anim_human",
            combat + 4950,
            combat + 4960,
            arf_blend_in_2 | arf_cyclic,
        ],
    ],
    [
        "defend_fist_parry_1",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        [
            defend_parry_duration_1,
            "anim_human",
            combat + 4962,
            combat + 4970,
            arf_blend_in_0,
    ...
    [
        "defend_shield_keep",
        acf_parallels_for_look_slope | acf_anim_length(100),
        amf_rider_rot_shield
        | amf_priority_defend
        | amf_keep
        | amf_rider_rot_defend
        ...
        [
            ...
            defend + 118,
            defend + 120,
            arf_blend_in_4 | arf_cyclic,
        ],
    ],
    [
        "defend_shield_parry_1",
        acf_parallels_for_look_slope | acf_anim_length(100),
    ...
    [
        "defend_forward_greatsword_keep",
        0,
        amf_priority_defend
        | amf_use_defend_speed
        | amf_keep
        ...
        [
            ...
            170,
            170,
            arf_blend_in_3 | arf_cyclic,
        ],
    ],
    [
        "defend_forward_greatsword_parry_1",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
    ...
    [
        "defend_forward_greatsword_parry_2",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        #   [0.3, "anim_human", defend+320, defend+330, arf_blend_in_1],
        [0.6, "defend_twohanded", 350, 367, arf_blend_in_1],
    ...
    [
        "defend_forward_greatsword_parry_3",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        #   [0.3, "anim_human", defend+320, defend+330, arf_blend_in_1],
        [0.6, "defend_twohanded", 350, 367, arf_blend_in_1],
    ...
    [
        "defend_right_twohanded_parry_1",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        [
            defend_parry_duration_1,
    ...
    [
        "defend_right_twohanded_parry_2",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        [
            defend_parry_duration_2,
    ...
    [
        "defend_right_twohanded_parry_3",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        [
            defend_parry_duration_3,
    ...
    [
        "defend_forward_onehanded_parry_1",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
    ...
    [
        "defend_forward_onehanded_parry_2",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        #   [0.3, "anim_human", defend+1021, defend+1030, arf_blend_in_1],
    ...
    [
        "defend_forward_onehanded_parry_3",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        #   [0.3, "anim_human", defend+1021, defend+1030, arf_blend_in_1],
    ...
    [
        "defend_right_onehanded_parry_1",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        [
            defend_parry_duration_1,
    ...
    [
        "defend_right_onehanded_parry_2",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        [
            defend_parry_duration_2,
    ...
    [
        "defend_right_onehanded_parry_3",
        0,
        amf_priority_defend_parry | amf_play | amf_restart | amf_rider_rot_defend,
        [
            defend_parry_duration_3,
    ...
    [
        "strike_abdomen_right",
        0,
        amf_priority_striked | amf_play | amf_accurate_body | amf_restart,
        [0.6, "strikes", 1168, 1188, arf_blend_in_3],
    ],
    [
        "strike_abdomen_front",
        0,
        amf_priority_striked | amf_play | amf_accurate_body | amf_restart,
    ...
    [
        ...
        [
            ...
            8,
            60,
            arf_blend_in_16 | arf_make_custom_sound,
            pack2f(0.5, 0.0),
            (0, 0, 0),
            0.6,
        ],
    ...
    ## ],
    [
        "fall_rider_right_forward",
        acf_enforce_all | acf_lock_camera,
        amf_priority_die | amf_accurate_body | amf_keep | amf_client_prediction,
        [
            2.2,
            "anim_human",
            blow + 200,
            blow + 275,
            arf_blend_in_3 | arf_make_custom_sound,
            pack2f(0.8, 0.0),
            (0, 0, 0),
            0.3,
        ],
    ...
    [
        "rider_fall_right",
        acf_enforce_all | acf_displace_position,
    ...
    [
        "strike_fall_back_rise",
        acf_enforce_lowerbody | acf_align_with_ground,
        amf_priority_striked | amf_play | amf_accurate_body | amf_restart,
        [
            1.7,
            "anim_human",
            blow + 5400,
            blow + 5453,
            arf_blend_in_2 | arf_make_custom_sound,
            pack2f(0.4, 0.0),
            (0, 0, 0),
            0.5,
        ],
    ...
    [
        "wedding_dad_stairs",
        0,
        amf_play | amf_priority_die | amf_start_instantly,
    ...
    [
        "wedding_groom_wait",
        0,
        amf_play | amf_priority_die | amf_start_instantly | amf_keep,
    ...
    [
        "release_overswing_spear_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_overswing_musket_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        "release_thrust_musket",
        acf_overswing,
        amf_priority_attack | amf_use_weapon_speed | amf_play | amf_continue_to_next,
        [0.9, "musket_thrust_forward", 19, 50, blend_in_release],
    ],
    [
        "release_thrust_musket_continue",
        0,
        amf_priority_continue
        | amf_use_weapon_speed
        | amf_play
    ...
    [
        ...
        [
            ...
            600,
            644,
            arf_cyclic | arf_use_stand_progress,
            0,
            (0, 0, 0),
            0.0,
        ],
    ...
    [
        ...
        [
            ...
            0,
            31,
            arf_cyclic | arf_use_walk_progress | arf_make_walk_sound,
            pack4f(0.25, 0.42, 0.75, 0.92),
            (0, 0, 0),
            0.25,
        ],
    ],
    ...
    [
        ...
        [
            ...
            31,
            0,
            arf_cyclic | arf_use_inv_walk_progress | arf_make_walk_sound,
            pack4f(0.07, 0.13, 0.56, 0.63),
            (0, 0, 0),
            0.0,
        ],
    ],
    ...
    [
        "horse_turn_right_head",
        0,
        amf_client_prediction,
        [1.0, "anim_horse", 500, 533, arf_blend_in_4 | arf_cyclic],
    ],
    [
        "horse_turn_left_head",
        0,
        amf_client_prediction,
        [1.0, "anim_horse", 450, 483, arf_blend_in_4 | arf_cyclic],
    ],
    [
        "horse_slow",
        0,
        amf_client_prediction,  # not used anymore?
        [3.0, "anim_horse", 0, 31, arf_cyclic],
        [1.5, "anim_horse", 0, 31, arf_cyclic],
    ],
    [
        "horse_fall_in_place",
        acf_enforce_all | acf_align_with_ground,

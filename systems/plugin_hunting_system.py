...
party_templates =[
    ("deer_herd","Deer Herd",icon.cattle|carries_goods(10),0,fac.wild_animals,merchant_personality,[(trp.deer,5,25)]),
]
factions =[
...
troops = [
  ["deer","Deer","Deer",0,no_scene,reserved,fac.neutral, [], def_attrib|level(0),wp(60),0,mercenary_face_1, mercenary_face_2],
]
...
sounds = [
 ("deer_dying", sf_2d|sf_priority_9|sf_vol_10,["deer_dying.wav"]),
]
mission_templates = [
  (
    ...
    [
      ...
      (0, 0, ti_once, [ #spawing deers
		     (party_count_members_of_type, l.num_deers, g.g_encountered_party, trp.deer),
		     (val_sub, l.num_deers,1),
		     (ge,l.num_deers,0),
                     (assign,g.num_deers_killed,0),
...
#identifica el animal para sonido chief
      (ti_on_agent_killed_or_wounded, 0, 0, [
        ...
        (agent_get_troop_id,l.cur_troop_id,l.dead_agent_no),

        (eq,l.cur_troop_id,trp.deer),
...
###sonidos acaba
      ...
      (5,0,0,
      [
      (neg|agent_is_alive,g.leading_deer),
      ],
      [
      (try_for_agents,reg(1)),
      	(agent_get_item_id,reg(2),reg(1)),
		...
		(val_add,l.num_kills,1),
	      ...
	      (gt,l.num_kills,g.num_deers_killed),	      
		     ...
		     (position_set_z_to_ground_level,pos1),
	             ...
	             (assign,g.num_deers_killed,l.num_kills),
      ]),
      (5,0,0,[],
      [

...
party_templates = [
    ...
    ("enemy", "Enemy", icon.gray_knight, 0, fac.outlaws, merchant_personality, []),
    (
        "hero_party",
        "Hero Party",
        icon.gray_knight,
    ...
    (
        ...
        fac.outlaws,
        bandit_personality,
        [(trp.steppe_bandit, 4, 58)],
    ),
    (
        "taiga_bandits",
        "Tundra Bandits",
        icon.axeman | carries_goods(2),
        0,
        fac.outlaws,
        bandit_personality,
    ...
    (
        "merchant_caravan",
        "Merchant Caravan",
        icon.gray_knight | carries_goods(20) | pf_auto_remove_in_town | pf_quest_party,
        0,
        fac.commoners,
        escorted_merchant_personality,
        [(trp.caravan_master, 1, 1), (trp.caravan_guard, 5, 25)],
    ),
    (
        "troublesome_bandits",
        "Troublesome Bandits",
        icon.axeman | carries_goods(9) | pf_quest_party,
        0,
        fac.outlaws,
        bandit_personality,
        [(trp.bandit, 14, 55)],
    ...
    (
        ...
        icon.axeman | carries_goods(9) | pf_auto_remove_in_town | pf_quest_party,
        0,
        fac.neutral,
        bandit_personality,
        [(trp.bandit, 24, 58), (trp.kidnapped_girl, 1, 1, pmf_is_prisoner)],
    ),
    (
        "kidnapped_girl",
        "Kidnapped Girl",
        icon.woman | pf_quest_party,
        0,
        fac.neutral,
        merchant_personality,
    ...
    (
        ...
        fac.neutral,
        merchant_personality,
        [(trp.farmer, 6, 7), (trp.peasant_woman, 3, 3)],
    ),
    (
        "spy",
        "Ordinary Townsman",
        icon.gray_knight | carries_goods(4) | pf_default_behavior | pf_quest_party,
        0,
        fac.neutral,
        merchant_personality,
        [(trp.spy, 1, 1)],
    ...
    (
        "kingdom_hero_party",
        "War Party",
        icon.flagbearer_a | pf_show_faction | pf_default_behavior,
        0,
        fac.commoners,
        soldier_personality,
        [],
    ...
    (
        ...
        fac.commoners,
        0,
        [(trp.swadian_recruit, 5, 10), (trp.swadian_militia, 2, 4)],
    ),
    (
        ...
        fac.commoners,
        0,
        [(trp.swadian_footman, 3, 6), (trp.swadian_skirmisher, 2, 4)],
    ),
    (
    ...
    (
        ...
        fac.commoners,
        0,
        [(trp.vaegir_recruit, 5, 10), (trp.vaegir_footman, 2, 4)],
    ),
    (
        ...
        0,
        [
            (trp.vaegir_veteran, 2, 4),
            (trp.vaegir_skirmisher, 2, 4),
            (trp.vaegir_footman, 1, 2),
        ],
    ),
    (
        ...
        fac.commoners,
        0,
        [(trp.vaegir_horseman, 2, 3), (trp.vaegir_infantry, 1, 2)],
    ),
    (
    ...
    (
        ...
        0,
        [
            (trp.khergit_horseman, 2, 4),
            (trp.khergit_horse_archer, 2, 4),
            (trp.khergit_skirmisher, 1, 2),
        ],
    ),
    (
    ...
    (
        ...
        fac.commoners,
        0,
        [(trp.nord_footman, 5, 10), (trp.nord_recruit, 2, 4)],
    ),
    (
        ...
        fac.commoners,
        0,
        [(trp.nord_huntsman, 2, 5), (trp.nord_archer, 2, 3), (trp.nord_footman, 1, 2)],
    ),
    (
    ...
    (
        ...
        fac.commoners,
        0,
        [(trp.rhodok_tribesman, 5, 10), (trp.rhodok_spearman, 2, 4)],
    ),
    (
        ...
        fac.commoners,
        0,
        [(trp.rhodok_crossbowman, 3, 6), (trp.rhodok_trained_crossbowman, 2, 4)],
    ),
    (
        ...
        fac.commoners,
        0,
        [(trp.rhodok_veteran_spearman, 2, 3), (trp.rhodok_veteran_crossbowman, 1, 2)],
    ),
    (
        ...
        fac.commoners,
        0,
        [(trp.sarranid_recruit, 5, 10), (trp.sarranid_footman, 2, 4)],
    ),
    (
        ...
        0,
        [
            (trp.sarranid_skirmisher, 2, 4),
            (trp.sarranid_veteran_footman, 2, 3),
            (trp.sarranid_footman, 1, 3),
        ],
    ),
    (
    ...
    (
        ...
        "{!}bandit_lair_templates_end",
        icon.axeman | carries_goods(2) | pf_is_static,
        0,
        fac.outlaws,
        bandit_personality,
        [(trp.sea_raider, 15, 50)],
    ...
    (
        "leaded_looters",
        "Band of robbers",
        icon.axeman | carries_goods(8) | pf_quest_party,
        0,
        fac.neutral,
        bandit_personality,
        [(trp.looter_leader, 1, 1), (trp.looter, 3, 3)],
    ),
]

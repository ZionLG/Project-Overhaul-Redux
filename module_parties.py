...
parties = [
    ...
    (
        "village_16",
        "Shapeshte",
        icon.village_snow_a | pf_village,
        no_menu,
        pt.none,
        fac.neutral,
        0,

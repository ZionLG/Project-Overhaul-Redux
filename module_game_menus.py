            ...
            (
                ...
                [
                    (try_for_range, ":npc", companions_begin, companions_end),
	                    ...
	                    (
	                        display_message,
	                        "@{!}{s4}: M{reg3}, 2M{reg4}, PC{reg5}, 2PC{reg6}, PM{reg7}",
	                    ),
                    (try_end),
                ],
            ),
                ...
                [
                    ...
                    (try_begin),
	                    ...
	                    (else_try),
		                    ...
		                    (
		                        try_begin
		                    ),  # only 2 guard because there is a fire at one owned village
			                    (ge, ":cur_day_hour", 6),
			                    (lt, ":cur_day_hour", 22),
			                    (set_visitors, 25, ":tier_2_troop", 1),
			                    ...
			                    (
		                        else_try
			                    ),  # only 1 guard because both night and there is a fire at one owned village
			                    (set_visitors, 25, ":tier_2_troop", 1),
			                    (set_visitors, 26, ":tier_2_troop", 0),
            ...
            (
                ...
                [
                    ...
                    (else_try),
	                    ...
	                    (
	                        try_begin
	                    ),  # this doubles the incidence of ransom brokers and (below) minstrels
		                    (
		                        party_get_slot,
		                        ":ransom_broker",
		                        "$current_town",
	                    ...
	                    (else_try),
		                    ...
		                    (try_begin),
			                    ...
			                    (
			                        display_message,
			                        "@{!}DEBUG - Current town is {s3}, but also checking {s4}",
			                    ),
		                    (try_end),
		                    (
		                        party_get_slot,
	                    ...
	                    (try_begin),
		                    ...
		                    (
		                        this_or_next | neg | check_quest_finished,

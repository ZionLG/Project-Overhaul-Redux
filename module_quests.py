...
quests = [
    ...
    (
        "kill_local_merchant",
        "Assassinate Local Merchant at {s3}",
        qf_random_quest,
        "{!}{s9} asked you to assassinate a local merchant at {s3}.",
    ),
    (
        "bring_back_runaway_serfs",
    ...
    (
        "deliver_cattle_to_army",
        "Deliver {reg3} Heads of Cattle to {s13}",
        qf_random_quest,
        "{!}None",
    ),
    ...
    (
        "deliver_message_to_prisoner_lord",
        "Deliver Message to {s13} at {s14}",
        qf_random_quest,
        "{!}None",
    ),
    # Courtship quests
    ...
    (
        "duel_courtship_rival",
        "Challenge {s13} to a Trial of Arms (optional)",
        qf_random_quest,
        "{!}None",
    ),
    # Other duel quests
    (
        "duel_avenge_insult",
        "Challenge {s13} to a Trial of Arms",
        qf_random_quest,
        "{!}None",
    ),
    ##################
    ...
    (
        "move_cattle_herd",
        "Move Cattle Herd to {s13}",
        qf_random_quest,
        "{!}Guildmaster of {s10} asked you to move a cattle herd to {s13}.",
    ),
    (
        "escort_merchant_caravan",
        "Escort Merchant Caravan to {s8}",
        qf_random_quest,  # make this a non-random quest?
        "{!}Escort the merchant caravan to the town of {s8}.",
    ),
    (
        "deliver_wine",
        "Deliver {reg5} Units of {s6} to {s4}",
        qf_random_quest,
 ...
 After that you are to bring the girl back to {s4}.",
    ...
    (
        ...
        "Make Sure Two Lords Do Not Object to Peace",
        qf_random_quest,  # possibly deprecate., or change effects
 ...
 In order to do that, you must either convince them or make sure they fall captive and remain so until a peace agreement is made.",
    ...
    (
        "deliver_cattle",
        "Deliver {reg5} Heads of Cattle to {s3}",
        qf_random_quest,
        "{!}The elder of the village of {s3} asked you to bring {reg5} heads of cattle.",
    ),
    (
        "train_peasants_against_bandits",
        "Train the Peasants of {s13} Against Bandits.",
        qf_random_quest,
        "{!}None",
    ),
    ...
    (
        "eliminate_bandits_infesting_village",
        "Save the Village of {s7} from Marauding Bandits",
        qf_random_quest,
    ...
    (
        "track_down_provocateurs",
        "Track Down Provocateurs",
        qf_random_quest,
        "{!}{s9} of {s4} asked you to track down a group of thugs, hired to create a border incident between {s5} and {s6}.",
    ),
    (
        "retaliate_for_border_incident",
        "Retaliate for a Border Incident",
        qf_random_quest,
    ...
    (
        "raid_caravan_to_start_war",
        "Attack a Neutral Caravan to Provoke War",
        qf_random_quest,
        "{!}placeholder",
    ),
    (
        "cause_provocation",
        "Give a Kingdom Provocation to Attack Another",
        qf_random_quest,
        "{!}placeholder",
    ),  # replaces raid_caravan_to_start_war
    (
        "rescue_prisoner",
        "Rescue or Ransom a Prisoner",
        qf_random_quest,
        "{!}placeholder",
    ...
    ("blank_quest_2", "{!}blank_quest", qf_random_quest, "{!}placeholder"),
    ("blank_quest_3", "{!}blank_quest", qf_random_quest, "{!}placeholder"),
    ("blank_quest_4", "{!}blank_quest", qf_random_quest, "{!}placeholder"),
    ("blank_quest_5", "{!}blank_quest", qf_random_quest, "{!}placeholder"),
    ("blank_quest_6", "{!}blank_quest", qf_random_quest, "{!}placeholder"),
    ("blank_quest_7", "{!}blank_quest", qf_random_quest, "{!}placeholder"),

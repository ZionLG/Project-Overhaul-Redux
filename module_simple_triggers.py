...
simple_triggers = [
        ...
        [
            ...
            (try_for_parties, ":party_no"),
	            ...
	            (
	                str_store_string,
	                s65,
	                "str_party_with_commander_mismatch__check_log_for_details_",
	            ),
	            (try_begin),
    ...
    # Apply interest to merchants guild debt by 1% (once a week)
    (
        24 * 7,
        [
	            ...
	            (else_try),  # Otherwise, act freely
		            ...
		            (try_begin),
			            ...
			            (
			                ...
			                ":spawnpoint",
			                ":bandit_party_template",
			                slot_party_template_lair_spawnpoint,
			            ),
